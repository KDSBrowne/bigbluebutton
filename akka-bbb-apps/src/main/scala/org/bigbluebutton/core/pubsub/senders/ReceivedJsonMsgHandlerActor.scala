...
class ReceivedJsonMsgHandlerActor(
  ...
  def handle(envelope: BbbCoreEnvelope, jsonNode: JsonNode): Unit = {
    ...
    envelope.name match {
      ...
      case SetPageSelectedUserPubMsg.NAME =>
        routeGenericMsg[SetPageSelectedUserPubMsg](envelope, jsonNode)
      case SetPageUserSharedWithAllPubMsg.NAME =>
        routeGenericMsg[SetPageUserSharedWithAllPubMsg](envelope, jsonNode)
      ...
      case PresentationConversionFailedErrorSysPubMsg.NAME =>
        routeGenericMsg[PresentationConversionFailedErrorSysPubMsg](envelope, jsonNode)
